...
struct NetworkService {
    ...
    virtual void setRunMode(int mode) = 0;                                        //设置运行模式，0：VERBOSE模式，1：安静模式
};

struct NetworkServiceConfiguration {
    static int MAX_SENT_APPMESSAGE_MUNBER;
    static double PROB_OF_PACKET_LOSSED;
    static double PROB_OF_PACKET_CORRUPTED;
    static double ARRIVING_RATE_FROM_APPLAYER;
};
